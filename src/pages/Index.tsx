    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "Windows and mirror cleaned to a streak-free finish",
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <header className="fixed top-10 z-50 w-full border-b border-border/40 bg-background/80 backdrop-blur-md">
        <div className="mx-auto grid max-w-7xl grid-cols-[1fr_auto_1fr] items-center gap-4 px-6 py-3">
          ...
          <div className="flex items-center gap-2 justify-self-end sm:gap-3">
            ...
            <a
              href="https://www.facebook.com/profile.php?id=61590542520188&locale=en_GB"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Facebook"
              className="rounded-full border border-border p-2 text-muted-foreground transition hover:border-primary hover:text-primary"
      ...
      <section id="contact" className="mx-auto max-w-5xl px-6 py-24 text-center">
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-3">
          ...
          >
            <Instagram className="mx-auto h-6 w-6 text-primary" />
            <h3 className="mt-3 font-display text-xl">Message</h3>
          ...
          <ul className="mt-8 grid gap-4 sm:grid-cols-2">
            {[
              ...
              },
              {
                ...
                body: "A 50% non-refundable deposit is required to secure all bookings. Work will not begin until the deposit has been received. The deposit will be deducted from your final balance, with the remaining amount due upon completion of the service. If you need to reschedule, please provide at least 24 hours notice and your deposit can be transferred to a new appointment.",
              },
              {
                title: "Maintenance Valet",
